      ...
      <div class="container">
        <form action="" method="post">
          ...
          <div class="mb-2" style="width:250px">
            ...
            <input name="kodeobat" type="text" class="form-control" value="<?= $obat['kode_obat']; ?>"
          ...
          <div class="mb-2" style="width:250px">
            ...
            <input name="namaobat" type="text" class="form-control" value="<?= $obat['nama_obat']; ?>"
              id="exampleFormControlInput1" placeholder="merek obat">
          </div>
          <div class="mb-2" style="width:250px">
          ...
          <div class="mb-2" style="width:250px">
            ...
            <input name="dosis" type="text" class="form-control" value="<?= $obat['dosis']; ?>"
          ...
          <div class="mb-2" style="width:250px">
            ...
            <input name="harga" type="text" class="form-control" value="<?= $obat['harga']; ?>"
              id="exampleFormControlInput1" placeholder="harga">
          </div>
          <div class="mb-2" style="width:100px">
            <label for="exampleFormControlInput1" class="form-label">Ubah Stok :</label>
            <input name="stok" type="text" class="form-control" value="<?= $obat['stok']; ?>"
              id="exampleFormControlInput1" placeholder="stok">
          </div>
          <div class="mb-2" style="width:250px">
            <label for="exampleFormControlInput1" class="form-label">Ubah tanggal kadaluarsa :</label>
            <input name="expired" type="date" class="form-control" value="<?= $obat['expired']; ?>"
              id="exampleFormControlInput1" placeholder="expired">
          </div>
          <div class="mb-2" style="width:250px">
            <label for="exampleFormControlInput1" class="form-label">Ubah kemasan :</label>
            <input name="kemasan" type="text" class="form-control" value="<?= $obat['kemasan']; ?>"
              id="exampleFormControlInput1" placeholder="kemasan">
          </div>
          <div class="mb-2" style="width:250px">
            <label class="form-label">Ubah Kategori</label>
            <input name="kategori" type="text" class="form-control" value="<?= $obat['kategori']; ?>"
              id="exampleFormControlInput1" placeholder="kategori">
          </div>

...
<table border="1" style="text-align: center;">
    ...
    ?>
        <tr>
            <td style="text-align: center;" rowspan="<?= $jumlah_detail; ?>"><?= $i; ?></td>
            <td style="text-align: center;" rowspan="<?= $jumlah_detail; ?>"><?= $tanggal; ?></td>
            <td><?= $data_obat1['nama_obat']; ?> </td>
            <td style="text-align: center;"><?= $data_detail[0]['qty']; ?></td>
            <td style="text-align: right;"><?= number_format($data_obat1['harga'], 0, ',', '.'); ?></td>
            <td style="text-align: right;"><?= number_format($data_detail[0]['subtotal'], 0, ',', '.'); ?></td>
            <td style="text-align: center;" rowspan="<?= $jumlah_detail; ?>"><?= number_format($total, 0, ',', '.');; ?></td>
        </tr>
    <?php 
        if($jumlah_detail > 1) : 
    ...
    ?>      
                <tr>
                    ...
                    <td style="text-align: center;"><?= $data_detail[$j]['qty']; ?></td>
                    <td style="text-align: right;"><?= number_format($data_obat['harga'], 0, ',', '.'); ?></td>
                    <td style="text-align: right;"><?= number_format($data_detail[$j]['subtotal'], 0, ',', '.'); ?></td>
                </tr>
